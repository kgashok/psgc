/*
Create a Payroll Application for an Organization. This Application takes the employee_name, emp_id, email_id, hourly_rate and number of hours worked from the user and calculates the gross pay (hourly_rate * number of hours) and stores it in a file.
...
Store it in the appropriate text file. Generate a report of the employees whose gross_salary is higher than Rs.20000.
*/
