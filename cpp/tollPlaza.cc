      ...
      case 'Y': {
        ...
        switch (n) {
          case '1':
            ...
            int i = 1, weight, cash = 0, reciept = 0, totalvehicles = 0,
                Exchange, Amount;
            ...
            while (vehicle != 'O' && vehicle != 'o') {
...

              {
                ...
                std::cout << "Government car...no collection of cash"
                          << std::endl;
                totalvehicles = totalvehicles + 1;
                cash = cash;
                reciept = reciept;
            ...
            while (stats != 'E') {
              cout << "Enter S for Detailed vehicle stats. Or press E key to "
                      "end "
                      "program."
                   << endl;
              cin >> stats;
              ...
              switch (stats) {
                case 'S': {
                  ...
                  cout << "Motorbikes passed today      : " << Motorbike
                       << endl;
                  cout << "Government Cars passed today : " << GovernmentCar
                       << endl;
                  break;
                }

                default: { cout << "enter valid entry." << endl; }
              }
            }
        }
        break;
        ...
        case '2': {
          ...
          cout << "6-  weight of vehicle(if more than 100,,,double cash should "
                  "be "
